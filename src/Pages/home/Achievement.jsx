    ...
    return (
        <div className='my-14'>
            <div className="text-center relative mb-14">
                <h2 className="text-3xl sm:text-5xl font-bold">The Achievements We Get</h2>
                <p className="text-lg w-11/12 sm:w-3/5 mx-auto mt-3">We always try harder every day to give our customers the best experience.</p>
                <div className="w-28 h-1 bg-[#ff6898d2] absolute -bottom-3 left-1/2 -translate-x-1/2"></div>
            </div>
            <div className="flex flex-wrap justify-between">
                <div className="flex items-center gap-8 mx-auto my-5">
