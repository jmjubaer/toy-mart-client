        ...
        <div className="carousel h-screen w-full rounded-xl">
            <div id="slide1" className="carousel-item relative w-full justify-start">
                ...
                <div className="p-8 absolute text-center text-white bg-[#ff6899] bg-opacity-50 w-full h-full">
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full md:w-4/5">
                        <h1 className='text-2xl md:text-5xl font-bold'>Discover endless fun with our incredible collection of toys!</h1>
            ...
            <div id="slide2" className="carousel-item relative w-full justify-start">
                ...
                <div className="p-8 absolute text-center text-white bg-[#ff6899] bg-opacity-80 w-full h-full">
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full md:w-4/5">
                        <h1 className='text-2xl md:text-5xl font-bold'>Unleash the joy of playtime with our diverse range of toys for kids of all ages.</h1>
            ...
            <div id="slide3" className="carousel-item relative w-full justify-start">
                ...
                <div className="p-8 absolute text-center text-white bg-[#ff6899] bg-opacity-50 w-full h-full">
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full md:w-4/5">
                        <h1 className='text-2xl md:text-5xl font-bold'>Explore a world of excitement and adventure through our captivating toy assortment</h1>
            ...
            <div id="slide4" className="carousel-item relative w-full justify-start">
                ...
                <div className="p-8 absolute text-center text-white bg-[#ff6899] bg-opacity-50 w-full h-full">
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full md:w-4/5">
                        <h1 className='text-2xl md:text-5xl font-bold'>Immerse yourself in a world of imagination and play with our fantastic toy selection</h1>
