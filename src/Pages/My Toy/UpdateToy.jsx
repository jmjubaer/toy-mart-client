            ...
            <form onSubmit={handleSubmit(handleUpdate)}>
                <div className="flex w-full gap-8 my-8">
                    <label className="input-group">
                        <span className="bg-[#ff689887] w-1/4 text-lg">
                            Toy Name
                        </span>
                        <input
                            required
                            ...
                            className="border-2 px-3 border-[#ff689887] outline-none w-full"
                            {...register("name")}
                        />
                    </label>
                    <label className="input-group">
                        ...
                        <input
                            ...
                            className="border-2 p-3 border-[#ff689887] outline-none w-full"
                            {...register("photo")}
                        />
                    </label>
                </div>
                ...
                <div className="flex w-full gap-8 my-8">
                    ...
                    <label className="input-group">
                        ...
                        <input
                            ...
                            type="number"
                            placeholder="Enter Toy available Quantity"
                            className="border-2 p-3 border-[#ff689887] outline-none w-full"
